...
function generateReport($conn, $reportType) {
    ...
    switch ($reportType) {
        case 'daily':
            ...
            $sql = "SELECT * FROM reservation WHERE DATE(arrival_time) = CURDATE()";
            break;
        case 'weekly':
            // Generate weekly report
            $sql = "SELECT * FROM reservation WHERE YEARWEEK(arrival_time) = YEARWEEK(CURDATE())";
            break;
        case 'monthly':
            // Generate monthly report
            $sql = "SELECT * FROM reservation WHERE MONTH(arrival_time) = MONTH(CURDATE())";
            break;
        default:
            // Invalid report type
